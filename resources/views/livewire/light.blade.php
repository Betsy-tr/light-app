<div>
    ...
    <div class="progress" style="height: 30px;">
        <div class="progress-bar progress-bar-striped bg-warning" role="progressbar" aria-valuenow="{{$brightness}}" aria-valuemin="0" aria-valuemax="100" style="width: {{$brightness}}%"></div>
    </div>
    ...
    <div class="mt-3">
        ...
        <button class="btn btn-primary" wire:click="allumee">On</button>
    </div>
</div>
